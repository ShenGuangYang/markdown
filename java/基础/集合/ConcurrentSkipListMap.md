...
![img](../../../img/collection/ConcurrentSkipListMap.jpg)
...
![1573529114539](../../../img/collection/ConcurrentSkipListMap_1.jpg)
...
通过跳表的数据结构，我们知道跳表插入元素的时候会通过抛硬币的方式决定出它需要的层级，然后找到各层链中它所在的位置，最后通过单链表插入的方式把节点及索引插入进去来实现的。
...
![1573543835168](../../../img/collection/ConcurrentSkipListMap_2.jpg)



假如，我们现在要插入一个元素 10。

（1）寻找目标节点之	对应的数据节点，在这里也就是找到了7这个数据节点；

（2）从7开始向后遍历，找到目标节点的位置，也就是在9和12之间；

（3）插入10这个元素，Part I 结束；

![1573543952426](../../../img/collection/ConcurrentSkipListMap_3.jpg)
...
![1573544447466](../../../img/collection/ConcurrentSkipListMap_5.jpg)
...
![1573544324697](../../../img/collection/ConcurrentSkipListMap_4.jpg)
...
![1573545266126](../../../img/collection/ConcurrentSkipListMap_6.jpg)
...
![1573545528008](../../../img/collection/ConcurrentSkipListMap_7.jpg)
...
![1573545817954](../../../img/collection/ConcurrentSkipListMap_8.jpg)
